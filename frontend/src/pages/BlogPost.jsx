...
export default function BlogPost() {
  ...
  if (!post) {
    return (
      <div className="pt-20 min-h-screen bg-white flex flex-col items-center justify-center text-center px-4">
  ...
  return (
    <div className="pt-20 min-h-screen bg-white">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <Link
          to="/blogs"
          className="inline-flex items-center gap-2 text-brand-green font-semibold hover:underline mb-8"
        >
          <ArrowLeft className="w-4 h-4" /> Back to Blog
        </Link>
        ...
        {/* Content */}
        <div className="prose max-w-none text-slate-700 leading-relaxed space-y-4 mb-12 whitespace-pre-line">
          {content}
        </div>
