            ...
            <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative">
              <div className="relative aspect-[4/5] max-w-md mx-auto">
                ...
                <motion.div
                  ...
                  className="absolute -bottom-6 left-1/2 -translate-x-1/2 backdrop-blur-xl bg-slate-900/40 border border-white/20 rounded-2xl px-8 py-4 text-center shadow-lg"
                >
                  <h3 className="text-2xl font-bold text-white">Ustaz Abdul Muhaymin</h3>
